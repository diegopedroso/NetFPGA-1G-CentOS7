...
`define DEVICE_PROJ_DIR    "firewall"
`define DEVICE_PROJ_NAME   "FIREWALL"
...
`define FIREWALL_BLOCK_ADDR_WIDTH   18
`define FIREWALL_REG_ADDR_WIDTH     5
...
`define FIREWALL_BLOCK_ADDR     18'h00002
...
// Name: firewall
// Description: Registradores do Firewall
// File: projects/firewall/include/firewall.xml
`define FIREWALL_DPORT1  5'h0
`define FIREWALL_DPORT2  5'h1
`define FIREWALL_DPORT3  5'h2
`define FIREWALL_DPORT4  5'h3
